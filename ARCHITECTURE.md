...
- **The 9-layer pipeline overview**: §5 (architecture diagram)
- **Each layer in detail**: §5.3 through §5.11
...
When the plan stabilizes, its content will be split into this file plus the
docs/ tree and the standalone plan file will be archived.
